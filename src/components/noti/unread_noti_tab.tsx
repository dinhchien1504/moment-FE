...
const UnReadNotiTab = (props: Props) => {
    ...
    const { notiUnread, fetchGetNotiUnread, lockViewMoreNotiUnread, isLoadingNotiUnread, setNotiAll, notiAll, numberOfItemRemove, setNumberOfItemRemove } = props
